...
const VerbTampering = () => {
    ...
    return(
        <section>
            ...
            <details>
                <summary>Pierwszy typ luki związany z manipulacją czasownikiem HTTP jest spowodowany głównie niezabezpieczoną konfiguracją serwera internetowego i wykorzystanie tej luki może pozwolić nam na ominięcie monitu o podstawowe uwierzytelnienie HTTP na niektórych stronach.</summary>
            ...
            <details>
                <summary>Bypassing Security Filters</summary>
            ...
            <details>
                <summary className='defense'>Zapobieganie Verb Tampering</summary>
                <h2 className='defense'></h2>
